        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 space-y-4">
              ...
              <div key={index} className="p-4 rounded-xl border border-slate-300 bg-slate-50 space-y-3 shadow-sm">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    updated[index] = { ...updated[index], location: loc || '', item: item || '', unit: 't' };
                ...
                {entry.location && (
                  <div className="flex items-center gap-2 mt-2">
                    <input
                      ...
                      className="w-full p-3 rounded-xl bg-white border border-slate-300 text-xl font-extrabold text-right"
                    />
            ...
            <button
              ...
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3.5 rounded-xl text-base font-bold shadow"
            >
              ＋ スクラップ・処分場を追加
            </button>
          </div>
