  ...
  return (
    <div className="p-4 max-w-xl mx-auto space-y-4 font-sans pb-20 bg-slate-100 min-h-screen text-slate-800">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-white p-4 rounded-2xl border shadow-sm space-y-3">
           <div className="flex justify-between items-center border-b-2 pb-1">
             <span className="font-bold text-sm text-orange-600">??? 4. 処分場への搬出</span>
        ...
        <div className="bg-white p-4 rounded-2xl border shadow-sm space-y-3">
           <div className="flex justify-between items-center border-b-2 pb-1">
             <span className="font-bold text-sm text-orange-600">?? 5. スクラップの搬出</span>
        ...
        <div className="bg-white p-4 rounded-2xl border shadow-sm space-y-3">
           <div className="flex justify-between items-center border-b-2 pb-1">
             ...
             <button type="button" onClick={handleVoiceInput} className="bg-[#E56312] text-white text-xs px-3 py-1.5 rounded-lg font-bold shadow flex items-center gap-1">??? 声で入力</button>
           </div>
        ...
        {/* 7. 現場写真添付 */}
        <div className="bg-white p-4 rounded-2xl border shadow-sm space-y-2">
           <div className="font-bold text-sm text=><option key={l} value={l}>{l}</option>)}
             </select>
           </div>
